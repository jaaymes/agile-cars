  ...
  const onSubmitEdit = async (data: FormValuesProps) => {
    const image =
      typeof data.avatarUrl === "string"
        ? data.avatarUrl
        : await convertBase64(data.avatarUrl);
    try {
                ...
                <Card sx={{ py: 6.5, px: 4 }}>
                  ...
                  >
                    <RHFTextField
                      ...
                      value={values.descricaoFuncionario || ""}
                    />
                    <RHFTextField
                      InputLabelProps={{
                        shrink: true,
                    ...
                    <RHFTextField
                      ...
                      name="phoneNumber"
                      label="Celular"
                      value={normalizePhone(values.phoneNumber) || ""}
                    />
                    ...
                    <Box>
                      ...
                      <Typography
                        variant="caption"
                        sx={{ mb: 0.5, color: colors?.grey[500] }}
                      >
                        senha padrao: 123456
                      </Typography>
                    </Box>
                  ...
                  >
                    ...
                    <Button
                      variant="outlined"
                      color="inherit"
                      onClick={() => push("/admin/colaboradores")}
                    >
                      Cancelar
                    </Button>
                  </Stack>
