...
export default function FranqueadosCreatePage() {
  ...
  const [dataFranqueador, setDataFranqueador] =
    useState<FormValuesProps | null>(null);
                ...
                <Card sx={{ py: 6.5, px: 4 }}>
                  ...
                  >
                    <RHFTextField
                      ...
                      name="descricaoFranqueado"
                      label="Nome do Franqueador"
                    />

                    <RHFTextField
                      InputLabelProps={{ shrink: true }}
                      value={normalizeCnpj(watchAllFields.cnpj) || ""}
                      name="cnpj"
                      label="CNPJ da Empresa"
                    />
                    <RHFTextField
                      InputLabelProps={{ shrink: true }}
                      value={normalizeCpf(watchAllFields.cpf) || ""}
                      name="cpf"
                    ...
                    <RHFTextField
                      ...
                      value={normalizeWhatsapp(watchAllFields.whatsapp) || ""}
                      name="whatsapp"
                      label="WhatsApp"
                    />
                  ...
                  >
                    ...
                    <Button
                      variant="outlined"
                      color="inherit"
                      onClick={() => push("/admin/franqueados")}
                    >
                      Cancelar
                    </Button>
                  </Stack>
